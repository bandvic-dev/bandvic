          ...
          <div className="resume-wrapper content-wrapper">
            <div className="resume-row">
              ...
              <div className="resume-content content">
                ...
                <p>I’m looking for an interesting remote job with a flexible schedule. I want to work and travel. I want to rise as frontend developer particular with Vue and everything related to it and may be full stack developer in feature.
                </p>
